...
// actually this is probably one of the proper things in this source, and im fairly certain that geico didn't fuck with this;
// so i doubt at any point this will need to be reworked, i'll just have to check my other source that has the exact same bone manager to see if it was fucked with.
