...
{
	auto mem = reinterpret_cast<void* (__thiscall*)(C_BaseEntity*, int)>(Memory::Scan(XorStr("client.dll"), XorStr("55 8B EC 57 8B F9 83 BF ?? ?? 00 00 00 75 07 33 C0 5F 5D C2 04 00")));
	return mem(this, framenumber);
}
